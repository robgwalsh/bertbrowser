...
public static class SyntaxTokenizer
{
    ...
    private static readonly Dictionary<string, SyntaxLanguage> ByExtension = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        [".manifest"] = SyntaxLanguage.Xml, [".appxmanifest"] = SyntaxLanguage.Xml,
        [".xsd"] = SyntaxLanguage.Xml, [".xsl"] = SyntaxLanguage.Xml, [".xslt"] = SyntaxLanguage.Xml,
        [".dtd"] = SyntaxLanguage.Xml, [".rss"] = SyntaxLanguage.Xml, [".atom"] = SyntaxLanguage.Xml,
        [".opml"] = SyntaxLanguage.Xml, [".sitemap"] = SyntaxLanguage.Xml, [".axaml"] = SyntaxLanguage.Xml,
        [".vcxproj"] = SyntaxLanguage.Xml, [".shproj"] = SyntaxLanguage.Xml, [".pubxml"] = SyntaxLanguage.Xml,
        [".ruleset"] = SyntaxLanguage.Xml, [".runsettings"] = SyntaxLanguage.Xml,
        [".wxs"] = SyntaxLanguage.Xml, [".wxi"] = SyntaxLanguage.Xml, [".storyboard"] = SyntaxLanguage.Xml,
        [".cshtml"] = SyntaxLanguage.Xml, [".razor"] = SyntaxLanguage.Xml, [".vbhtml"] = SyntaxLanguage.Xml,
        [".aspx"] = SyntaxLanguage.Xml, [".ascx"] = SyntaxLanguage.Xml, [".master"] = SyntaxLanguage.Xml,
        [".jsp"] = SyntaxLanguage.Xml,
        [".prettierrc"] = SyntaxLanguage.Json, [".eslintrc"] = SyntaxLanguage.Json,
        [".babelrc"] = SyntaxLanguage.Json, [".stylelintrc"] = SyntaxLanguage.Json,
        [".gitmodules"] = SyntaxLanguage.Ini, [".gitconfig"] = SyntaxLanguage.Ini,
        [".npmignore"] = SyntaxLanguage.Ini, [".htaccess"] = SyntaxLanguage.Ini,
