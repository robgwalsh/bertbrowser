...
namespace BertStat.App.Views;

public partial class MainWindow : Window
{
    private readonly ShellViewModel _shell;
    private readonly BertStat.App.Services.AppSettings _settings;

    public MainWindow(ShellViewModel shell, BertStat.App.Services.AppSettings settings)
    {
        InitializeComponent();
        _shell = shell;
        _settings = settings;
